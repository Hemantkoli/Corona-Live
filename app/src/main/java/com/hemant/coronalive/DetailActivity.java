...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCountry = findViewById(R.id.tvfCountry);
        tvCases = findViewById(R.id.tvfCases);
        tvRecovered = findViewById(R.id.tvfRecovered);
        tvCritical = findViewById(R.id.tvfCritical);
        tvActive = findViewById(R.id.tvfActive);
        tvTodayCases = findViewById(R.id.tvfTodayCases);
        tvTotalDeaths = findViewById(R.id.tvfDeaths);
        tvTodayDeaths = findViewById(R.id.tvfTodayDeaths);
        ...
        tvTotalDeaths.setText(AffectedCountries.countryModelList.get(positionCountry).getDeath());
